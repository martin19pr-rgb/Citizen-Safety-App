  ...
  return (
    <main className="min-h-screen pb-32 pt-12 px-6 flex flex-col max-w-2xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-10">
        <div>
          <h1 className="font-headline text-2xl font-bold tracking-tight">Provincial Safety</h1>
      ...
      <div className="flex-1 flex flex-col gap-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <GlassCard className="flex flex-col gap-2 p-4">
            ...
            <span className="text-2xl font-headline font-bold">14</span>
          ...
          <GlassCard className="flex flex-col gap-2 p-4">
            ...
            <span className="text-2xl font-headline font-bold">03</span>
        ...
        <section>
          ...
          <div className="flex flex-col gap-3">
            {[1, 2].map((i) => (
              <GlassCard key={i} className="flex items-center gap-4 p-3 hover:bg-white/10 cursor-pointer">
